...
$workExperience = [
    [
        ...
        'data' => '10.10.2021 - ',
        'data2' => 'current',
        'description' => 'обладает обширным объемом знаний по имеющейся специальности 
        и всегда находится в курсе последних событий в своей области'
    ],
    [
        'name' => 'AO.Horns and hooves',
        'data' => '05.05.2018 - 09.10.2021',
        'data2' => '',
        'description' => 'зарекомендовал себя как ответственный сотрудник, нацеленный на отличный результат, 
        всегда готов к быстрому принятию инновационных решений и несению ответственности за их принятие'
    ],
    [
        'name' => 'OOO.Horns and hooves',
        'data' => '03.03.2015 - 04.05.2018',
        'data2' => '',
        'description' => 'Готов к работе в любых условиях, в т. ч. в нерабочее время.'
    ],
];
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            ?>
              <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExperience[$i]["data"]?> <span
                    class="w3-tag w3-teal w3-round"><?php echo $workExperience[$i]["data2"]?></span></h6>
